...
$string['error:missingpreferences'] = 'Missing required auto freezing preference fields.';
$string['error:overridecontextfreeze'] = 'You do not have permission to update read only settings.';
...
$string['error:view'] = 'You do not have permission to view read only settings.';
